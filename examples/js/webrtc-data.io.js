...
(function() {
  ...
  rtc.createPeerConnection = function(id) {
    ...
    pc.onicecandidate = function(event) {
		...
		/* Removing this handler since Chrome sends a ton of ice canidates and we only need one */
  ...
  rtc.createDataChannel = function(pcOrId, label) {
	...
	if (rtc.dataChannelSupport == reliable_false) {
		return; /* support for only reliability true options = {reliable: false};  */
	}else{
